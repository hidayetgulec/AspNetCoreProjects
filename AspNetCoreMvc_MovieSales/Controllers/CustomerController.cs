    ...
    public class CustomerController : Controller
    {
        ...
        public IActionResult ConfirmPayment(CustomerFaturaViewModel model)
        {
            ...
            if(_movieSaleDetailRepo.AddRange(sepet, saleId))
            {
                ...
                //Session'lar hafızadan temizlenecek.
                HttpContext.Session.Remove("sepet"); //sadece sepeti temizler. Aktif kullanıcının session değeri korunuyor. Yeni alışveriş yapabilir.
                //HttpContext.Session.Clear(); //Aktif oturumdaki tüm session'ları temizler.

                //Sepet detaylarındaki ürünlerin stok miktarları güncellenecek (satış adeti kadar düşülecek).
